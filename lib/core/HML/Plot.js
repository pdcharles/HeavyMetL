...
HML.Plot = function() {
 ...
 var ProteinIncorp = function(proteinQuant,files) {
  ...
  var titleTxt = new fabric.Text("Label Incorporation Rate (%)", {textAlign: "left", fill:"black", fontSize: tickFontSize+2, fontFamily:HML.ui.fontFamily, left: -(gWidth/2), top: -(gHeight/2), originX: "left", originY: "top", fontStyle:"italic", fontWeight:"bold"});
  g.add(titleTxt);
  return g;
 }
