...
document.addEventListener( "DOMContentLoaded", function() {
 ...
 HML.Interface = function() {
  ...
  var featureLookup = function(protein,peptide,charge,modstring) {
   return Interface.FeaturesArray[Interface.FeaturesObject[protein][peptide][charge][modstring]];
  };
     ...
     if (fname) {
      if (fname && (Interface.AvailableFileNames.indexOf(fname) < 0)) {
       ...
       if (!Interface.FeaturesObject[protein][peptide][charge][modstring]) {
        ...
        Interface.FeaturesObject[protein][peptide][charge][modstring] = Interface.FeaturesArray.length;
        Interface.FeaturesArray.push(featureData);
       }
       else {
        var feature = featureLookup(protein,peptide,charge,modstring)
