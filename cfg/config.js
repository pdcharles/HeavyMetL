...
HML.config = {
 ...
 _rawFileMaxBlockProcessSize : Math.pow(2,27), //String length limit is (2^28)-1 in Firefox and (2^28)-(2^4) in Chrome.  N.B. Safari has a limit of (2^31)-1 but Safari is not a currently targeted browser.  If processing Thermo Raw Files (and therefore using ArrayBuffers not strings) the memory limit is potentially much larger.  The default of 2^27 avoids some memory-related stability issues at higher values.
 //!!Experimental!!:
